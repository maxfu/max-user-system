...
<?php foreach ( $user_query->results as $user ) { ?>
        <tr>
            ...
            <td class="body-item mbr-fonts-style display-7"><?php _e( 'Company Email', 'max-user' ); ?>: <?php echo $user->company_email; ?></td>
            <td class="body-item mbr-fonts-style display-7"><?php _e( 'Company Website', 'max-user' ); ?>: <?php echo $user->user_url; ?></label></th>
            <td class="body-item mbr-fonts-style display-7"><?php _e( 'Company Address', 'max-user' ); ?>: <?php echo $user->company_address; ?></td>
            <td class="body-item mbr-fonts-style display-7"><?php _e( 'Company Telephone', 'max-user' ); ?>: <?php echo $user->company_phone; ?></td>
            <td class="body-item mbr-fonts-style display-7"><?php _e( 'Second Email', 'max-user' ); ?>: <?php echo $user->second_email; ?></td>
